        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
          ...
          <Panel className="p-5">
            ...
            <p className="mt-4 text-xs text-ink-faint">
              MoSPI = Ministry of Statistics and Programme Implementation&apos;s official CPI Airfare sub-index —
              an external, independently published reference, not our own data.
            </p>
          </Panel>
        </div>
      )}
